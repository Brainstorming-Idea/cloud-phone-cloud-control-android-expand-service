...
public class Predictor {
    ...
    protected volatile List<OcrResultModel> ocrResultModels = null;
    ...
    public ArrayList<OcrResultModel> getOcrResult(){
        return (ArrayList<OcrResultModel>) this.ocrResultModels;
    }
