package com.cloud.control.expand.service.widget;
...
public class RecyclerViewSpacesItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public RecyclerViewSpacesItemDecoration(int spanCount, HashMap<String, Integer> spaceValue, boolean includeEdge) {
