...
public class CommonHintDialog extends Dialog implements View.OnClickListener {
    ...
    public CommonHintDialog(Context context, int theme) {
        super(context, theme);
     ...
     * @param rightStr
     */
    private void setStyle(String title, String content, String leftStr, String rightStr) {
        if (TextUtils.isEmpty(content)) {
            ...
            if (content.contains("</font>")) {
                ((TextView) findViewById(R.id.tv_dialog_content)).setText(Html.fromHtml(content));
            } else {
     ...
     * @param callback
     */
    public static void show(Context context, String title, String content, String leftStr, String rightStr,
                            MenuCallback callback) {
        CommonHintDialog dialog = new CommonHintDialog(context,
                R.style.dialog_style);
        dialog.setMenuCallback(callback);
        dialog.setStyle(title, content, leftStr, rightStr);
        dialog.show();
     ...
     * @param dialog
     */
    private void initDialog(Context context, CommonHintDialog dialog) {
