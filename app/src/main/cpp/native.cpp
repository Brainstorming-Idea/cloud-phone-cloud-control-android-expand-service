...
Java_com_cloud_control_expand_service_module_ocr_OCRPredictorNative_init(
...
Java_com_cloud_control_expand_service_module_ocr_OCRPredictorNative_forward(
...
Java_com_cloud_control_expand_service_module_ocr_OCRPredictorNative_release(
